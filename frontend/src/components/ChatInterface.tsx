  ...
  const handleChatUpload = async (file: File) => {
    ...
    if (!convId) {
      ...
      try {
        ...
        showUploadError('Failed to create conversation for upload.')
        return
      }
    }
    try {
      ...
      showUploadError('Failed to upload document. Please try again.')
    }
  }
    ...
    <div style={styles.container}>
      ...
      <form onSubmit={handleSubmit} style={styles.inputBar}>
        ...
        <button
          ...
          style={{
            ...styles.sendBtn,
            opacity: loading || !input.trim() || input.length > MAX_INPUT_LENGTH ? 0.4 : 1,
          }}
        >
      ...
      {input.length > 0 && (
        <div style={{
          ...styles.charCount,
          ...(input.length > MAX_INPUT_LENGTH ? { color: 'var(--danger, #d94b4b)' } : {}),
        }}>
